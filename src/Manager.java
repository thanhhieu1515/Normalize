...
public class Manager {
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("C:\\Users\\admin\\OneDrive\\Documents\\NetBeansProjects\\JP.L.P0025\\src\\input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\admin\\OneDrive\\Documents\\NetBeansProjects\\JP.L.P0025\\src\\output.txt", true)));
            String line;
